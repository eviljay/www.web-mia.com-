...
<body>
    <form name="aspnetForm" method="post" action="OteviraciDoba.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjgPZBYCZg9kFgICAw9kFgICBQ9kFgICBw8PFgQeCENzc0NsYXNzBQhzZWxlY3RlZB4EXyFTQgICZGRk8kkuvmhlsKYnwh+B/0uE/8kL2tw=" />
...
<div id="header">
    ...
    <h1>
        Otevírací doba</h1>
    <table style="border: none;white-space:nowrap;" width="200px">
        <colgroup>
            <col width="30%" />
            <col width="70%" />
        </colgroup>
...
<div id="menu">
    <ul>
        ...
        <li>
            <a id="ctl00_menu_hlOpeningHours" class="selected" href="OteviraciDoba.aspx">Otevírací doba</a></li>
        <li>
            <a id="ctl00_menu_hlPhotos" href="Fotogalerie.aspx">Fotogalerie</a></li>
        <li>
            <a id="ctl00_menu_hlContact" href="KontaktAMapa.aspx">Kontakt a mapa</a></li>
    </ul>
    <div id="top_list">
